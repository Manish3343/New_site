        ...
        <div class="menu-inner">
            <nav id="main_menu_wrap">
                <ul class="metismenu" id="menu">
                    ...
                    @endif
                    @if(check_page_permission_by_string('Faq'))
                    <li class="main_dropdown {{active_menu('admin-home/employer')}}">
                        <a href="{{route('admin.home.employer')}}" aria-expanded="true"><i class="ti-control-forward"></i>
                            <span>{{__('Employer')}}</span></a>
                    </li>
                    @endif
