        ...
        <div class="menu-inner">
            <nav id="main_menu_wrap">
                <ul class="metismenu" id="menu">
                    ...
                    <?php endif; ?>
                    <?php if(check_page_permission_by_string('Faq')): ?>
                    <li class="main_dropdown <?php echo e(active_menu('admin-home/employer')); ?>">
                        <a href="<?php echo e(route('admin.home.employer')); ?>" aria-expanded="true"><i class="ti-control-forward"></i>
                            <span><?php echo e(__('Employer')); ?></span></a>
                    </li>
                    <?php endif; ?>
