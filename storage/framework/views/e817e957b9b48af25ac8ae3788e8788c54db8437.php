<?php $__env->startSection('section'); ?>
    <div class="dashboard-form-wrapper">
        ...
        <form action="<?php echo e(route('user.profile.update')); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="address"><?php echo e(__('Pan Card')); ?></label>
                <input type="file" class="form-control" id="pan_card" name="pan_card" value="">
            </div>
            <div class="form-group">
                <label for="address"><?php echo e(__('Aadhar Card')); ?></label>
                <input type="file" class="form-control" id="aadhar_card" name="aadhar_card" value="">
            </div>
            <div class="form-group">
                <label for="address"><?php echo e(__('RL')); ?></label>
                <input type="file" class="form-control" id="rl" name="rl" value="">
            </div>
            <div class="form-group">
                <label for="address"><?php echo e(__('10th Marksheet')); ?></label>
                <input type="file" class="form-control" id="ten_marksheet" name="ten_marksheet" value="">
            </div>
            <div class="form-group">
                <label for="address"><?php echo e(__('Graduation markesheet')); ?></label>
                <input type="file" class="form-control" id="g_marksheet" name="g_marksheet" value="">
            </div>
            <button type="submit" class="submit-btn dash-btn width-200"><?php echo e(__('Save changes')); ?></button>
        </form>
    </div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.dashboard.user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\latest xampp\htdocs\vayetech\resources\views/frontend/user/dashboard/edit-profile.blade.php ENDPATH**/ ?>