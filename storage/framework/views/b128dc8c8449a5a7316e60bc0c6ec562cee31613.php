...
<?php endif; ?>
                        <form action="<?php echo e(route('user.register')); ?>" method="post" enctype="multipart/form-data" class="account-form">
                            ...
                            <input type="hidden" name="referal_code" value="<?php echo e(Request::get('unique')); ?>">
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\latest xampp\htdocs\vayetech\resources\views/frontend/employee/register.blade.php ENDPATH**/ ?>