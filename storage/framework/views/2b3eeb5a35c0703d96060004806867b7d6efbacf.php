            ...
            <div class="col-lg-12 mt-t">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.home14.counterup')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="form-group">
                                <label for="home_page_14_counterup_section_background_image"><?php echo e(__('Background Image')); ?></label>
                                ...
                                <div class="media-upload-btn-wrapper">
                                    ...
                                    <input type="hidden" name="home_page_14_counterup_section_background_image" value="<?php echo e($image_id); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\latest xampp\htdocs\vayetech\resources\views/backend/pages/home/creative-design-agency/counterup-area.blade.php ENDPATH**/ ?>