...
<?php endif; ?>
                        <form action="<?php echo e(route('user.register')); ?>" method="post" enctype="multipart/form-data" class="account-form">
                            ...
                            <div class="form-group">
                          <select class="form-control" name="user_type" value="<?php echo e(old('user_type')); ?>">
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\latest xampp\htdocs\vayetech\resources\views/frontend/user/register.blade.php ENDPATH**/ ?>