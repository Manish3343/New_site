...
==============================================*/
    ...
    Route::prefix('faq')->middleware(['adminPermissionCheck:Faq'])->group(function () {
        ...
        Route::get('employer','EmployerController@index')->name('admin.home.employer');
        Route::get('add-employer','EmployerController@create')->name('admin.employer.create');
        Route::post('employer-store','EmployerController@store')->name('admin.employer.store');
        Route::get('employer-edit/{id}','EmployerController@create')->name('admin.edit.employer');
        Route::post('employer-update/{id}','EmployerController@update')->name('admin.employer.update');
        Route::get('employer-delete/{id}','EmployerController@destroy')->name('admin.delete.employer');
