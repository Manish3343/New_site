...
/*----------------------------------
    USER DASHBOARD
-----------------------------------*/
Route::prefix('dashboard')->middleware(['userEmailVerify', 'setlang:frontend', 'globalVariable', 'maintains_mode'])->group(function () {
  ...
  //  Route::get('/course-certificate/download/{id}', 'UserDashboardController@course_certificate_download')->name('user.dashboard.course.certificate.download');
   ...
   // Route::post('support-ticket/message', 'UserDashboardController@support_ticket_message')->name('user.dashboard.support.ticket.message');
    ...
    # Employer routes
    Route::get('clients','EmployerDashboardController@index')->name('employer.clients');
    Route::get('employer/document','EmployerDashboardController@upload_document')->name('employer.document');
});
